...
#define floatListItemWidth 120
#define floatListItemHeight 40

@interface KLFloatListView ()
...
@property (nonatomic, assign) KLFloatListViewLocateMethod method;

@end

@implementation KLFloatListView
...
- (void)layoutSubviews {
    ...
    switch (self.method) {
        case KLFloatListViewLocateMethodRightTop: {
...
- (void)resetSubviews {
    int i = 0;
    for (KLFloatListItem *item in self.items) {
